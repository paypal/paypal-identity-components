...
import { EventEmitterType } from "@krakenjs/belter/dist/esm";
import { ZalgoPromise } from "@krakenjs/zalgo-promise";
import { create, CONTEXT } from "@krakenjs/zoid/src";
  ...
  return inlineMemoize(getAuthComponent, () => {
    const component = create({
      ...
      prerenderTemplate: ({
        ...
        return (<SpinnerPage nonce={props.nonce} />).render(
          dom({
            doc,
          })
        );
      ...
      containerTemplate: ({
        ...
        prerenderFrame: HTMLElement | null | undefined;
        props: AuthPropsType;
      }) => {
        const { nonce } = props;
        return (
